                ...
                <UCard class="text-center">
                    <div class="py-4 space-y-4">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            I make edits in Premiere Pro & After Effects, also I
                            make custom Discord bots... and websites too!
                        </p>
                ...
                <UCard>
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                class="relative pb-[56.25%] h-0 overflow-hidden rounded-lg shadow-md"
                            >
                    ...
                    <p class="mb-4">
                        If videos are not showing up or you want to see more,
                        you can click this button below!
                    </p>
                    <UButton
                        block
            ...
            <div class="max-w-2xl mx-auto mb-8 space-y-4">
                <UCard>
                    <h3 class="text-lg font-medium mb-3">
                        I can make a custom Discord bot/website for you!
                    </h3>
                    <p class="mb-2">I made this website all by myself!</p>
                    <p class="mb-4">
